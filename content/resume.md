...
{{< timelineItem icon="bug" header="Certified Ethical Hacker" badge="2019" >}}
...
{{< timelineItem icon="star" header="Academic Excellence" badge="2017" >}}
...
{{< timelineItem icon="music" header="RCM Grade 7 Piano" badge="2010" >}}
{{< badge >}}
First Class Honours
{{< /badge >}}
Royal Conservatory of Music piano certification.
{{< /timelineItem >}}
...
{{< timelineItem icon="shield" header="Insomni'hack teaser 2020" badge="2020" subheader="#17 - Maple Bacon" >}}
...
{{< timelineItem icon="code" header="Trend Micro CTF 2019 Qualifier" badge="2019" subheader="#6 - Maple Bacon" >}}
{{< badge >}}
Qualified for Finals
{{< /badge >}}
Top 6 performance securing qualification for international finals.
{{< /timelineItem >}}
...
**NahamCon CTF 2020** (#380 - Insider Threats)<br>
**PlaidCTF 2020** (#501 - Insider Threats)<br>
**UTCTF 2020** (#343 - Insider Threats)<br>
...
**Electric Bicycle Assembly and Repairs** - Hands-on hardware experience<br>
**FL Studio Music Production** - Creative audio engineering<br>
**Photography** - Amateur Photoshop skills for visual storytelling<br>
