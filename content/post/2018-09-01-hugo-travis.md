...
2. Download the versions of hugo to compile your website and minify to minimize the autogenerated HTML/CSS/JS code
3. Run Hugo to compile your website into the `/public` directory
4. Minify the `/public` directory
5. Deploy the generated public folder into the target branch which conveniently is the document root of our Github Pages website
